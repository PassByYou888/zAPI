 ...
 *
 *  Author:   API Hub Tool Team <support@apihubtool.com>
 *  Version:  2.3 (FPC-compatible, all warnings fixed)
 *  Date:     2026-08-10
 *  Compiler: Free Pascal 3.0+ and Delphi XE+
 *  Dependencies: z_api_hubtool_import.pas, z_api_hubtool_helper.pas,
 *                dynamic library (z_api_hub64.dll / .so / .dylib)
 *
 *  Output:   Console (UTF‑8, works on Windows/Linux/macOS)
 ******************************************************************************}
