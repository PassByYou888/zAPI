(*
  ...
  *   }
  *   int main() {
  *       TAppHnd___ app = API_Create_APPHnd("Demo", "Example");
...
type
  ...
  { * TAppHnd___: Opaque handle to an application context (TAPI_APP).
...
{ * API_Create_APPHnd: Creates a new application context with the given
  ...
  * @Example:
  *   TAppHnd___ app = API_Create_APPHnd("my_app", "Example application");
  *   // register APIs...
  *   API_Free_APPHnd(app); }
function API_Create_APPHnd(appName, Desc: pansichar): TAppHnd___; cdecl;
...
procedure API_Free_APPHnd(appHnd: TAppHnd___); cdecl;
...
function API_Reg_Call(appHnd: TAppHnd___; APIName, Desc: pansichar; Trigger: Pointer; OnCall: TAPI_Call): integer; cdecl;
...
function API_Reg_Notify(appHnd: TAppHnd___; APIName, Desc: pansichar; Trigger: Pointer; OnNotify: TAPI_Notify): integer; cdecl;
...
function API_UnReg(appHnd: TAppHnd___; APIName: pansichar): integer; cdecl;
...
function API_Local_APP_Call(appHnd: TAppHnd___; Param: TDataHnd___): TDataHnd___; cdecl;
...
{ * API_Local_APP_Notify: Sends a notification locally within the
  ...
  *       free it separately. }
procedure API_Local_APP_Notify(appHnd: TAppHnd___; Param: TDataHnd___); cdecl;
...
function API_Prepare_Client(PhysicsAddr_: pansichar; appHnd: TAppHnd___): integer; cdecl;
...
{ * API_Create_APPHnd: Creates a TAPI_APP object, sets its name and
  ...
  * @Returns: A new TAppHnd___ (pointer to TAPI_APP). }
function API_Create_APPHnd(appName, Desc: pansichar): TAppHnd___;
var
  app: TAPI_APP;
begin
  app := TAPI_APP.Create;
...
procedure API_Free_APPHnd(appHnd: TAppHnd___);
var
  app: TAPI_APP;
...
function API_Reg_Call(appHnd: TAppHnd___; APIName, Desc: pansichar; Trigger: Pointer; OnCall: TAPI_Call): integer;
var
  app: TAPI_APP;
...
function API_Reg_Notify(appHnd: TAppHnd___; APIName, Desc: pansichar; Trigger: Pointer; OnNotify: TAPI_Notify): integer;
var
  app: TAPI_APP;
  APIName__, Desc__: TAPI_String;
begin
...
function API_UnReg(appHnd: TAppHnd___; APIName: pansichar): integer;
var
  app: TAPI_APP;
...
function API_Local_APP_Call(appHnd: TAppHnd___; Param: TDataHnd___): TDataHnd___;
var
  app: TAPI_APP;
  tmp: TMem64;
begin
...
{ * API_Local_APP_Notify: Sends a notification locally.
  ...
  * @Param appHnd: The application handle.
  * @Param Param: Input data handle. }
procedure API_Local_APP_Notify(appHnd: TAppHnd___; Param: TDataHnd___);
var
  app: TAPI_APP;
  tmp: TMem64;
begin
...
function API_Prepare_Client(PhysicsAddr_: pansichar; appHnd: TAppHnd___): integer;
var
  Host, Port: U_String;
  Cmd_: TAPI_String;
